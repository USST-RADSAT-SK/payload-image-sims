function image=sr_bw(t2,offset_wb,scale_wb,ds,max_shift,th_prob1,th_prob2,no_iter)
...
tic
[image,probs,shs,scores]=sr_one_step_wb(image,t2,'average',ds,search_range,sigma,th_prob1); %,...
toc

fprintf('start super-resolution 2nd phase...\n');
for iter=1:no_iter
    tic
    [image,probs,shs,scores]=sr_one_step_wb(image,t2,'sort_pocs',ds,search_range,sigma,th_prob2);
    toc
    iter
